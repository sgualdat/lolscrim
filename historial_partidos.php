                ...
                <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php
                             ...
                             $link = mysqli_connect("127.0.0.1","root","","db696349657");
                             $resultado=$link->query("SELECT * FROM `agenda` WHERE `estado` = 'PENDIENTE' OR `estado` = 'ACEPTADO'");
                ...
                <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php
                             ...
                             $link = mysqli_connect("127.0.0.1","root","","db696349657");
                             $resultado=$link->query("SELECT * FROM `agenda` WHERE `estado` = 'FINALIZADO'");
                                ...
                                <thead>
                                    ...
                                    <?php
                                        while($row=mysqli_fetch_array($resultado)){
                                                ...
                                                <th><?php printf ("%s\n", $row["elo"]);?></th>
                                                <th><?php printf ("%s\n", $row["estado"]);?></th>
                                                <th><button id="consultarEstadisticas" name="consultarEstadisticas" class="btn btn-primary">Consultar</button></th>
                                                </tr>
                                                <?php     
                                        }
                                    ?>
